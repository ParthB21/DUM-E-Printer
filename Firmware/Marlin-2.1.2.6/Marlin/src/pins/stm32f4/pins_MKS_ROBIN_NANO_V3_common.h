...
#define Z_DIR_PIN                           PB4
...
#if ENABLED(DUME_ARTICULATED_ARM)
  // Physical E0 socket → I/A (wrist roll); physical E1 socket → extruder E
  ...
  #define I_MIN_PIN                         PC4   // Z+ / E0_DIAG endstop plug
#else
  ...
  #if ENABLED(DUME_ARTICULATED_ARM)
    #define I_SERIAL_TX_PIN                 PD9   // physical E0 driver UART
    #define E0_SERIAL_TX_PIN                PD8   // physical E1 driver UART
  #else
