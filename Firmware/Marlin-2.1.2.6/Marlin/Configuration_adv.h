...
#define HOMING_BUMP_MM      { 5, 5, 2, 5 }    // X Y Z I (° for joints)
...
#define AXIS_RELATIVE_MODES { false, false, false, false, false } // X Y Z I E
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 50*60, 2*60 } // X Y Z I E (°/min or mm/min)
