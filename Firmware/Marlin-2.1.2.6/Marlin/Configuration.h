...
// DUM-E: remap physical E0 → rotational A (wrist roll), physical E1 → extruder E
#define DUME_ARTICULATED_ARM
...
#define CUSTOM_MACHINE_NAME "DUM-E"
...
#define I_DRIVER_TYPE  TMC2209  // Wrist roll on physical E0 socket (DUME_ARTICULATED_ARM)
//#define J_DRIVER_TYPE  A4988
//#define K_DRIVER_TYPE  A4988
//#define U_DRIVER_TYPE  A4988
//#define V_DRIVER_TYPE  A4988
//#define W_DRIVER_TYPE  A4988
#define E0_DRIVER_TYPE TMC2209  // Filament extruder on physical E1 socket
...
#define USE_IMIN_PLUG   // Wrist roll (A) on Z+ / E0_DIAG connector
 ...
 * DUM-E joint-space: X/Y/Z/A are degrees (gearbox-only estimates; calibrate belts with M92).
 * Override with M92
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 124.44, 8.89, 453.33, 8.89, 95 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 30, 30, 20, 30, 25 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 80, 80, 60, 80, 500 }
...
#define I_ENABLE_ON 0 // Wrist roll (A)
...
// The size of the printable area (unused for joint-space; soft limits below matter)
#define X_BED_SIZE 360
#define Y_BED_SIZE 180

// Travel limits (DUM-E: joint degrees for X/Y/Z/A) after homing, corresponding to endstop positions.
...
// Homing speeds (linear=mm/min, rotational=°/min) — X Y Z I
#define HOMING_FEEDRATE_MM_M { (10*60), (10*60), (8*60), (10*60) }
